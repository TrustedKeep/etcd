...
import (
	...
	"github.com/TrustedKeep/etcd/pkg/netutil"
	"github.com/TrustedKeep/etcd/pkg/srv"
...
type Config struct {
	...
	//
	// See https://github.com/TrustedKeep/etcd/issues/9333 for more detail.
...
func (cfg *Config) SetupLogging() {
	...
	if cfg.LogPkgLevels != "" {
		repoLog := capnslog.MustRepoLogger("github.com/TrustedKeep/etcd")
