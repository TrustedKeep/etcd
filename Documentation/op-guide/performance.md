...
Benchmarking etcd performance can be done with the [benchmark](https://github.com/TrustedKeep/etcd/tree/master/tools/benchmark) CLI tool included with etcd.
