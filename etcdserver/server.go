...
import (
	...
	"github.com/TrustedKeep/etcd/alarm"
	"github.com/TrustedKeep/etcd/auth"
	"github.com/TrustedKeep/etcd/compactor"
	"github.com/TrustedKeep/etcd/discovery"
	"github.com/TrustedKeep/etcd/etcdserver/api"
	"github.com/TrustedKeep/etcd/etcdserver/api/v2http/httptypes"
	pb "github.com/TrustedKeep/etcd/etcdserver/etcdserverpb"
	"github.com/TrustedKeep/etcd/etcdserver/membership"
	"github.com/TrustedKeep/etcd/etcdserver/stats"
	"github.com/TrustedKeep/etcd/lease"
	"github.com/TrustedKeep/etcd/lease/leasehttp"
	"github.com/TrustedKeep/etcd/mvcc"
	"github.com/TrustedKeep/etcd/mvcc/backend"
	"github.com/TrustedKeep/etcd/pkg/fileutil"
	"github.com/TrustedKeep/etcd/pkg/idutil"
	"github.com/TrustedKeep/etcd/pkg/pbutil"
	"github.com/TrustedKeep/etcd/pkg/runtime"
	"github.com/TrustedKeep/etcd/pkg/schedule"
	"github.com/TrustedKeep/etcd/pkg/types"
	"github.com/TrustedKeep/etcd/pkg/wait"
	"github.com/TrustedKeep/etcd/raft"
	"github.com/TrustedKeep/etcd/raft/raftpb"
	"github.com/TrustedKeep/etcd/rafthttp"
	"github.com/TrustedKeep/etcd/snap"
	"github.com/TrustedKeep/etcd/store"
	"github.com/TrustedKeep/etcd/version"
	"github.com/TrustedKeep/etcd/wal"
...
var (
	plog = capnslog.NewPackageLogger("github.com/TrustedKeep/etcd", "etcdserver")
