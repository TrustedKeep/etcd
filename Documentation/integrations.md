...
- [etcdctl](https://github.com/TrustedKeep/etcd/tree/master/etcdctl) - A command line client for etcd
...
- [etcd/clientv3](https://github.com/TrustedKeep/etcd/blob/master/clientv3) - the officially maintained Go client for v3
- [etcd/client](https://github.com/TrustedKeep/etcd/blob/master/client) - the officially maintained Go client for v2
