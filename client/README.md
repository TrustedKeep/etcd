...
[![GoDoc](https://godoc.org/github.com/TrustedKeep/etcd/client?status.png)](https://godoc.org/github.com/TrustedKeep/etcd/client)
...
```bash
go get github.com/TrustedKeep/etcd/client
```
