...
import (
	...
	"github.com/TrustedKeep/etcd/etcdserver/api/v2v3"
	"github.com/TrustedKeep/etcd/etcdserver/api/v3client"
	"github.com/TrustedKeep/etcd/etcdserver/api/v3rpc"
	"github.com/TrustedKeep/etcd/pkg/cors"
	"github.com/TrustedKeep/etcd/pkg/debugutil"
	runtimeutil "github.com/TrustedKeep/etcd/pkg/runtime"
...
var plog = capnslog.NewPackageLogger("github.com/TrustedKeep/etcd", "embed")
...
func stopServers(ctx context.Context, ss *servers) {
	...
	// and https://github.com/TrustedKeep/etcd/issues/8916
	if ss.secure {
		shutdownNow()
		return
	}
